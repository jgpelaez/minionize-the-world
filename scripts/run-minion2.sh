...
docker run -d -p 8080:8080 --name="minion-front" --link minion-ipsum:sirius-minion-ipsum --link minion-characters:sirius-minion-characters --link minion-characters2:sirius-minion-characters2 --link scripts_eureka_1:Sirius-eureka --hostname="sirius-minion-front" ehdez73/minion-front
